...
password = "authpass"
DATABASE_URL = f"postgresql+psycopg2://authuser:{quote_plus(password)}@auth-db:5432/authdb"
...
for i in range(10):
    try:
        ...
        print(f"Tentando conectar ao banco... tentativa {i+1}/10")
        time.sleep(3)
else:
...
if __name__ == "__main__":
    import uvicorn
    uvicorn.run("record-api:app", host="0.0.0.0", port=8000, reload=True)